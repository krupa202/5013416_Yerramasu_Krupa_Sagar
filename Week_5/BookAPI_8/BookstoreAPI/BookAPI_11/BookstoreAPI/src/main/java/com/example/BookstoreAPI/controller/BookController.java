...
public class BookController {
    ...
    @GetMapping(value = "/books/{bookId}",  produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
    ...
    @PutMapping(value = "/books", consumes = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
    ...
    @GetMapping(value = "/books/title/{bookTitle}",  produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
    ...
    @GetMapping(value = "/books/author/{authorName}",  produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
    ...
    @GetMapping(value = "books/authors", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
